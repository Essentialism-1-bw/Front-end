...
const ProjectsPopup = ({ close }) => {
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', flexDirection: 'column', overflowY: 'auto', height: '90vh', padding: "2%"  }}>
            ...
            <h1>Add 3 Projects</h1>
            <Card className={classes.card}>
                <AddProjectsForm addProject={addProject} projects={projects}/>
            </Card>
            <ThemeProvider theme={theme}>
                ...
                <div style={{marginTop: '3%'}}>
                    {submitStatus === true ? <Link to="/dashboard"><Button variant="contained" color="primary" >Submit</Button></Link> : errorText}
                </div>
            </ThemeProvider>
        </div>
    )
