      ...
      <div className={classes.banner}>
        <div className={classes.centerCont}>
          ...
          <p className={classes.body}>
            Regain control of your own choices about where to spend your time
            and energy instead of giving others implicit permission to choose
            for you.
          </p>
          {/* <GetStarted /> */}
        </div>
        ...
        <div className={classes.section1}>
          <div>
            <h1 className={classes.mainTitle}>
              Welcome to The Essentialism App that allows you to list your
              project priorities according to your values.
            </h1>
            <br />
          </div>
          <h2 className={classes.mainTitle}>
            The first step is to select your 5 favorite values
          </h2>
        </div>
